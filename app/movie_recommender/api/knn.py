...
def get_recommendations(movie_id):  
    ...
    movie_neighbors_id = (algo.trainset.to_raw_iid(inner_id) for inner_id in movie_neighbors_inner_id)
    movie_neighbors = (neighbor_id for neighbor_id in movie_neighbors_id)
